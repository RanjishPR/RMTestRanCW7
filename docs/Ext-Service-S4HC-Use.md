...
---
## Prerequisites
 - [Register Your SAP S/4HANA Cloud System](../Ext-Service-S4HC-Register)
...
2. Check the list of **Communication Scenarios**.
    ...
    !!! hint "Further information about how to configure communication scenarios"
...
Otherwise, deploy your application as described in the tutorial [Multi-Target Application (MTA)](../CAP-MTA-Deployment).
...
1. Open your **SAP Build Work Zone, standard edition** site as described in the tutorial [Subscribe to the SAP Build Work Zone, Standard Edition](../Work-Zone-Subscribe).
...
3. Choose **Go**.
    ...
    !!! warning "In case you get an error `Forbidden`. "
        The following error is displayed when you haven't assigned your user to the `RiskManager-<your space>` role:

        ![Forbidden](markdown/images/error_forbidden.png)

        Follow the instructions in [Assign a Role Collection to a User](../Role-Assignment) to do it.
...
5. Fill in information for the new risk in the object page and choose **Create**.
    ...
    !!! tip "You can leave the **Mitigation** field empty, since there's no available mitigations to choose from."

6. Check if the new risk is visible.

    ![RiskTitle](markdown/images/risk_title.png)
