...
Welcome to this collection of tutorials for application development on SAP Business Technology Platform (SAP BTP). In the following tutorials, we provide information and examples on how to develop and deploy [SAP Cloud Application Programming Model (CAP)](https://cap.cloud.sap/) applications on [SAP BTP](https://developers.sap.com/tutorials/cp-explore-cloud-platform.html) using different tools and services step by step.
...
![Solution diagram](markdown/images/solutions_diagram.png)
